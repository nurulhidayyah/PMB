...
class CreateRekamMedisKehamilansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rekam_medis_kehamilans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rekam_medis_kehamilans');
    }
}
