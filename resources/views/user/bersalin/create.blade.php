...
@section('container')
    ...
    <form action="/user/rekam_medis/bersalin" method="post">
        @csrf
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input name="berat_bayi" id="berat_bayi" class="form-control @error('berat_bayi') is-invalid @enderror"
                        value="{{ old('berat_bayi') }}" required>
                    @error('berat_bayi')
                        <small class="text-danger pl-3">
                            {{ $message }}
                        </small>
                ...
                <div class="form-group">
                    ...
                    <input name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
